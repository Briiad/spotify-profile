...
const Login = () => {
  return (
    <div className='w-full h-screen flex justify-center items-center shadow-xl'>
      <motion.a href="https://damp-fortress-98049.herokuapp.com/login" className='text-white font-bold text-lg 2xl:text-3xl' variants={transition} initial="hidden" animate="visible" exit="exit">
